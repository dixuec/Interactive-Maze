...
public class Player extends GameCharacter implements java.io.Serializable{
    ...
    private Player(int x, int y) {
        super(x, y);
        URL u = Player.class.getResource("/resources/Images/L.png");
        blueLeftImg = new Image(u.toString());
        u = Player.class.getResource("/resources/Images/R.png");
        blueRightImg = new Image(u.toString());
        u = Player.class.getResource("/resources/Images/A.png");
        greenLeftImg = new Image(u.toString());
        u = Player.class.getResource("/resources/Images/D.png");
